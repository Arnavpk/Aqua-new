...
export const FEATURED_RIDES = [
  { artClass: 'bg-gradient-to-br from-brand-900 to-brand-600', badges: [{ label: 'THRILL', cls: 'chip-white' }, { label: 'NEW', cls: 'chip-coral' }], index: '01', category: 'Signature slide', name: 'Loopy Woopy', meta: '45s · 4-storey drop · 120cm+', slug: 'loopy-woopy' },
  { artClass: 'bg-gradient-to-br from-sun to-coral', badges: [{ label: 'FAMILY', cls: 'chip-white' }], index: '02', category: 'Group raft', name: 'Boomeranggo', meta: '2 min · 4-person raft · all ages', slug: 'boomeranggo' },
  { artClass: 'bg-gradient-to-br from-leaf to-brand-300', badges: [{ label: 'KIDS', cls: 'chip-white' }], index: '03', category: 'Splash pad', name: 'Sunny Side Up', meta: 'Unlimited · under 10s', slug: 'sunny-side-up' },
];
